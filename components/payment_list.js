...
const BadgeImg = props => (
  <img alt="Badge percent" src="/images/badge-percent.svg" {...props} />
)
const BandaidImg = props => (
  <img alt="Band aid" src="/images/band-aid.svg" {...props} />
)
const ChartImg = props => <img alt="Chart" src="/images/chart-area.svg" {...props} />
const GripImg = props => <img alt="Grip" src="/images/grip-lines.svg" {...props} />
...
const Badge = ({type}) => {
  switch (type) {
    case 'IDR':
      return (
        <span title="Payments are based on your discretionary income">
          <BadgeImg height="22px" fill="#999" />
        </span>
      )
    case 'PFH':
      return (
        <span title="Requires partial financial hardship">
